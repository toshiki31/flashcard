<!-- resources/views/flashcard/edit.blade.php -->
<!--編集画面-->
    ...
    <div class="max-w-7xl mx-auto sm:w-8/12 md:w-1/2 lg:w-5/12">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('flashcard.update',$flashcard->id) }}" method="POST">
            @method('put')
            @csrf
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="flashcard">flashcard</label>
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="flashcard" id="flashcard" value="{{$flashcard->flashcard}}">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="description">Description</label>
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="description" id="description" value="{{$flashcard->description}}">
            </div>
